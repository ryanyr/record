...
export default React.createClass({
    ...
    render:function(){ 
        ...
        return (
            <div className="pro">
                <div className="pro-basic" style={{paddingTop:'1rem'}}>
                    <div className="tip">同时申请多个平台，可以大大提高下款率哦！</div>
                    <div className="row">
                        <div className="col-3 pro-img">
                            <img className="" src='images/1.jpg'/>
                        </div>
                        <div className="col-7 pro-info">
                            <div>
                                <span className='pro-name'>{data.name}</span>
                                <span className='pro-tag'>{taglist}</span>                                
                        ...
                        <div className="col-2 pro-info text-center">
                            <div className='pro-apply'>{data.applyCount}人申请</div>
                ...
                <div className="pro-basic">
                    <p className="pro-basic-tit">
                        <span className="tit-hr"></span>申请条件
                    </p>
                    <p className="pro-basic-content">{data.applyCondition}</p>
                </div>
                <div className="pro-basic">
                    <p className="pro-basic-tit">
                        <span className="tit-hr"></span>申请流程
                    </p>
                ...
                <div className="pro-basic bottom-basic">
                    <p className="pro-basic-tit">
                        <span className="tit-hr"></span>产品说明
                    </p>
                    <p className="pro-basic-content">
